...
// File @chainlink/contracts/src/v0.8/interfaces/LinkTokenInterface.sol@v0.6.0
...
// File @chainlink/contracts/src/v0.8/interfaces/VRFV2WrapperInterface.sol@v0.6.0
...
// File @chainlink/contracts/src/v0.8/VRFV2WrapperConsumerBase.sol@v0.6.0
...
// File @chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol@v0.6.0
...
contract SlotMachine is VRFV2WrapperConsumerBase {
    ...
    function spin() public payable returns (bool) {
        /**Set Min and Max bet */
        uint256 minBetAmount = 100000000000000; //0.0001 ETH
        uint256 maxBetAmount = 10000000000000000; //0.01 ETH
        //Check user is eligible to play; Check contract has enough ETH;
        require(!Address.isContract(msg.sender), "Not EOA");
        require(
            address(this).balance > 10 * maxBetAmount,
    ...
    //How do I know how much net profit the contract has made at any given time?
    //Given that some user might not have withdrawn their balance in stored in the contract.
    //Seperate variable that track the win amount and withdraw. such as: int256 profit,
    //profit will be operated on every time there is a user deposit, or win amount.
    //How do I keep track of how many Link Tokens are used to pay for cost?
    //Seperate variable that keep track of difference of Link Token balance use.
}
